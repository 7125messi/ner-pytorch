...
def originHandle():
    with codecs.open('./renmin.txt','r',encoding='utf-8') as inp,\
            codecs.open('./renmin2.txt','w',encoding='utf-8') as outp:
...
def sentence2split():
    with codecs.open('./renmin3.txt','r',encoding='utf-8') as inp,\
            codecs.open('./renmin4.txt','w',encoding='utf-8') as outp:
        texts = inp.read()
